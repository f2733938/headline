...
package com.sanmi.microservice.headline.common.utils;

import com.hengyu.tools.validate.ValidateTools;
import com.sanmi.core.framework.util.BASE64Encoder;
...
public class DES3Util {
	...
	public static String encrypt(String content, String desKey, String charset)throws Exception {
		try {
			if(ValidateTools.isEmpty(desKey) || desKey.length() != 24) {
				throw new Exception("3des key's length must be 24");
			}
			if(ValidateTools.isEmpty(content)) {
				return "";
			}
