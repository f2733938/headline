    ...
    static final List URL_ALLOWS = new ArrayList() {
        {
            ...
            add("/view/fabuzhe.html");
            //排除详情页面
            add("/view/detail.html");
            add("/view/detail1.html");
            add("/view/detail2.html");
            //图片详情列表
            add("/view/comment-list.html");
            //排除绑定方法
            add("/user/login/bind");
            add("/user/login/getSession");
            add("/user/login/getShareInfo");
            //排除发送短信
